...
@section('content')
    ...
    <!-- START ABOUT -->
    <section class="section bg-white" id="about" style="padding: 40px 0px">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="text-center">
                        ...
                        <p class="text-muted mx-auto section-subtitle mt-3" style="text-align: justify">{!! $personInfo->working_hours_description ?? "" !!}</p>
                    </div>
                </div>
            </div>
            <div class="row mt-5">
                ...
                <div class="col-md-10">
                    <table class="table table-hover table-responsive table-bordered" style="text-align: center">
                        <thead class="thead-dark">
                           <tr>
                              <th class="col" scope="col">Day</th>
                              <th class="col" scope="col">Morning</th>
                              <th class="col" scope="col">Afternoon</th>
                           </tr>
                        </thead>
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td class="col">{{ \Carbon\Carbon::parse($row->time)->format('H:i') }} to {{ \Carbon\Carbon::parse($row->to_morning)->format('H:i') }}</td>
                              <td class="col">{{ \Carbon\Carbon::parse($row->afternoon_time)->format('H:i') }} to {{ \Carbon\Carbon::parse($row->to_afternoon)->format('H:i') }}</td>
