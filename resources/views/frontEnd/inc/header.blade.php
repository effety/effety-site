...
<nav class="navbar navbar-expand-lg custom-nav navbar-light fixed-top sticky">
    <div class="container">
        <a class="navbar-brand pt-0 logo" href="{{ route('home.user', ['id' =>  $userdd->id, 'first_name' =>   $userdd->first_name, 'last_name' =>   $userdd->last_name]) }}/#home">
            <img src="{{asset(optional($website)->website_logo)}}" alt="" class="img-fluid logo-light" style="width: 70px;">
            <img src="{{asset(optional($website)->website_logo)}}" alt="" class="img-fluid logo-dark"  style="width: 70px;">
        </a>
