            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        ...
                        <ol>
                            <li>
                                <a href="https://doctomed.ch/register" class="text-white">Register as professional</a>
                            </li>
                        </ol>
                        <ol>
                            <li>
                                <a href="https://doctomed.ch/patients/register" class="text-white">Patient Register</a>
                            </li>
                        </ol>
                        <ol>
                            <li>
                                <a href="https://doctomed.ch/company/register" class="text-white">Company Registraion</a>
                            </li>
                        </ol>
                    </div>
                </div>
